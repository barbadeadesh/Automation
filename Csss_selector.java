...
public class facebook_Css_SelectorTest {
	...
	public void css() throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("input[id='email']")).sendKeys("adeshbarbade7@gmail.com");
		driver.findElement(By.cssSelector("input[id='pass']")).sendKeys("Adesh@8888073562@gmail.com");
